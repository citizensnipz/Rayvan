    ...
    <section className="builder-form">
      ...
      <div className="field-grid three">
        ...
        {valueRouting && <>
          ...
          <label><span>Prediction head</span><select value={String(config.routing.value_head_type ?? "linear")} onChange={(e) => setConfig({ ...config, routing: { ...config.routing, value_head_type: e.target.value, ...(e.target.value === "geometric" ? { routing_geometry_dim: 32 } : {}) } })}><option value="linear">Linear</option><option value="mlp">Nonlinear (GELU)</option><option value="geometric">Relational geometric (slots + basins)</option></select></label>

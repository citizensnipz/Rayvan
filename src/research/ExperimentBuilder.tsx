    ...
    <section className="builder-form">
      ...
      <div className="field-grid three">
        ...
        {valueRouting && <>
          ...
          <label><span>Prediction head</span><select value={String(config.routing.value_head_type ?? "linear")} onChange={(e) => setNested("routing", "value_head_type", e.target.value)}><option value="linear">Linear</option><option value="mlp">Nonlinear (GELU)</option></select></label>

      ...
      <div className="field-grid three">
        ...
        {valueRouting && <>
          ...
          {expertConditioned && <>
            ...
            <p>Each expert has its own learned attention query and state view. Shared-distance competence basins predict suffix costs; a training-only decoder predicts integrated updates. Fresh probes plus replay train the router. For a decision-only control, set Cost MSE weight and Effect prediction weight to 0, and Decision regret weight to 1. This experiment requires frozen experts and fixed continuation; previous loss-only fitting banks are not used.</p>
          </>}

...
import { isClosableTab, tabId, tabKey, tabLabel, tabPanelId } from "./tab-ids.js";
...
export function FindingsTabBar({
  tabs,
  activeTabKey,
  onSelect,
  onClose,
  ...
  return (
    <div role="tablist" aria-label="Findings tabs" style={tabListStyle}>
      {tabs.map((tab, index) => {

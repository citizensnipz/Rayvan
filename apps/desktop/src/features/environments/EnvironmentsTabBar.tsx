...
interface EnvironmentsTabBarProps {
  tabs: EnvironmentTab[];
  activeTabKey: string;
...
export function EnvironmentsTabBar({
  tabs,
  activeTabKey,
  onSelect,
  onClose,
}: EnvironmentsTabBarProps) {
  ...
  return (
    <div role="tablist" aria-label="Environments tabs" style={tabListStyle}>
      {tabs.map((tab, index) => {

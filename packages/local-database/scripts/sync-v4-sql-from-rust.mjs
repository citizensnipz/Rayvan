/**
 * Sync the authoritative Rust v4 SQL file into the TypeScript migration const.
 *
 * Authority: crates/local-store/migrations/v4_environments_configuration.sql
...
const beginMarker = "export const V4_ENVIRONMENTS_AND_CONFIGURATION_SQL = `";
...
if (begin < 0 || end < 0 || end <= begin) {
  throw new Error(
    "Could not locate V4_ENVIRONMENTS_AND_CONFIGURATION_SQL block in migrations.ts",
  );
}

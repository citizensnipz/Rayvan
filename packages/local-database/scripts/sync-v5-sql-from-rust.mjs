/**
 * Sync the authoritative Rust v5 SQL file into the TypeScript migration const.
 *
 * Authority: crates/local-store/migrations/v5_desired_applied_configuration.sql
...
const beginMarker = "export const V5_DESIRED_APPLIED_CONFIGURATION_SQL = `";
...
if (begin < 0 || end < 0 || end <= begin) {
  throw new Error(
    "Could not locate V5_DESIRED_APPLIED_CONFIGURATION_SQL block in migrations.ts",
  );
}

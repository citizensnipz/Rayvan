...
/**
 * Plugin package setup sessions (v8).
 * Authoritative source: `crates/local-store/migrations/v8_plugin_packages_setup.sql`
 */
export const V8_PLUGIN_PACKAGES_SETUP_SQL = `
